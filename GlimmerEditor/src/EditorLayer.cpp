...
namespace gl {
	...
	void EditorLayer::OnAttach() {
		...
		m_ShaderLib.Load("assets/shaders/TrainScene.glsl");
		m_NoiseSource = gl::Texture2D::Create("assets/textures/NoiseTex.png");
	...
	void EditorLayer::OnUpdate(Timestep ts) {
...

		{
			...
			m_NoiseSource->Bind(0);
			auto trainShader = m_ShaderLib.Get("TrainScene");
			trainShader->UploadUniformInt("u_NoiseTexture", 0);
			Renderer2D::DrawFullscreenQuad(trainShader, 0.9f);
